...
jest.mock('../../BulletPoints/BulletPoints', () => ({
  BulletPoints: ({ listType, listStyleType, bulletList }: any) => (
    <div data-testid="bullet-points" data-list-type={listType} data-list-style-type={listStyleType}>
...
describe('Text', () => {
  ...
  it('ignores subtitle when both title and subtitle provided', () => {
    render(
      <Text content={['Test content']} sectionTitle="Main Title" sectionSubTitle="Sub Title" />,
    );
  ...
  it('applies custom border color to hr', () => {
    render(<Text content={['Test']} sectionTitle="Title" borderColor="red" />);
  ...
  it('handles mixed content types', () => {
    ...
    const content = ['Plain text', '<strong>HTML text</strong>', complexEntry];
  ...
  it('generates correct section ID from title', () => {
    ...
    expect(container).toHaveAttribute(
      'aria-labelledby',
      'tsx-cmpnt-text-section-title-my-section-title',
    );
  });
  ...
  it('applies text alignment to section titles', () => {
    render(<Text content={['Test']} sectionTitle="Centered Title" textAlign="center" />);
