    ...
    <>
      ...
      <LeftRightContent
        leftContent={
          <StackedContent
            topContent={
              <Content>
                <img src="https://placehold.co/300x200/EEE/31343C" alt="Placeholder Left" />
              </Content>
            }
            bottomContent={
              <Content>
        ...
        rightContent={
          <Content>
            <img src="https://placehold.co/600x400/EEE/31343C" alt="Placeholder Left" />
          </Content>
        }
      ...
      <Content direction="row" height="250px">
        ...
        <StackedContent
          topContent={
            <Content>
              <img src="https://placehold.co/200x100/EEE/31343C" alt="Placeholder Left" />
            </Content>
          }
          bottomContent={
            <Content>
      ...
      <Text textAlign="left" content={[lorem]} indent={true} />

      <Text textAlign="justify" content={[lorem]} indent={false} />

      <Text sectionTitle="Rightward" textAlign="right" content={[lorem]} indent={false} />
        ...
        content={[
          {
            ...
            listType: 'ul',
            listStyleType: 'disc',
            subBulletList: ['Fast performance', 'Modular architecture', 'Developer-friendly APIs'],
          },
