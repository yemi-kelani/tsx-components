...
describe('StackedContent', () => {
  ...
  it('applies custom className to container', () => {
    const { container } = render(<StackedContent {...defaultProps} className="custom-stacked" />);
  ...
  it('applies custom className to top content', () => {
    const { container } = render(<StackedContent {...defaultProps} topClassName="custom-top" />);
  ...
  it('applies custom gap as string', () => {
    const { container } = render(<StackedContent {...defaultProps} gap="2rem" />);
  ...
  it('applies custom gap as number', () => {
    const { container } = render(<StackedContent {...defaultProps} gap={24} />);
  ...
  it('handles empty className gracefully', () => {
    const { container } = render(<StackedContent {...defaultProps} className="" />);
  ...
  it('renders with string content', () => {
    render(<StackedContent topContent="Simple top text" bottomContent="Simple bottom text" />);
  ...
  it('handles zero gap correctly', () => {
    const { container } = render(<StackedContent {...defaultProps} gap={0} />);
  ...
  it('handles CSS custom properties as gap', () => {
    const { container } = render(<StackedContent {...defaultProps} gap="var(--spacing-large)" />);
