...
describe('Content', () => {
  ...
  it('renders with custom HTML tag', () => {
    const { container } = render(<Content as="section" {...defaultProps} />);
  ...
  it('applies custom gap', () => {
    const { container } = render(<Content {...defaultProps} gap="2rem" />);
  ...
  it('applies custom direction', () => {
    const { container } = render(<Content {...defaultProps} direction="row" />);
  ...
  it('applies custom width', () => {
    const { container } = render(<Content {...defaultProps} width="50%" />);
  ...
  it('applies custom height', () => {
    const { container } = render(<Content {...defaultProps} height="300px" />);
  ...
  it('renders with semantic HTML tags', () => {
    const { container: articleContainer } = render(<Content as="article">Article content</Content>);

    const { container: mainContainer } = render(<Content as="main">Main content</Content>);

    const { container: asideContainer } = render(<Content as="aside">Aside content</Content>);
  ...
  it('handles CSS custom properties in dimensions', () => {
    const { container } = render(
      <Content width="var(--content-width)" height="var(--content-height)" gap="var(--content-gap)">
  ...
  it('maintains centering behavior with different directions', () => {
    ...
    const { container: rowContainer } = render(<Content direction="row">Row content</Content>);
