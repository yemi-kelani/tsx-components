...
describe('Code', () => {
  ...
  it('renders basic code block with text', () => {
    render(<Code type="basic" text="console.log('hello');" language="javascript" />);
  ...
  it('passes through additional attributes', () => {
    render(
      <Code type="basic" text="test" data-testid="code-component" aria-label="Code example" />,
    );
  ...
  it('renders both language and caption when provided', () => {
    render(<Code type="basic" text="test" language="javascript" caption="Hello world example" />);
