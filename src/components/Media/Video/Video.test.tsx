...
describe('Video', () => {
  ...
  it('generates correct video id from src', () => {
    ...
    const video = document.querySelector('video');
    expect(video).toBeInTheDocument();
    expect(video).toHaveAttribute('id', 'tsx-cmpnt-video-https%3A%2F%2Fexample.com%2Fmy%20video.mp4');
  });
  ...
  it('handles special characters in src for id generation', () => {
    ...
    const video = document.querySelector('video');
    const expectedId = 'tsx-cmpnt-video-https%3A%2F%2Fexample.com%2Fvideo%20with%20spaces%20%26%20symbols!.mp4';
